...
description: 'Privacy Policy for Euler Foundation'
---
...
You may opt-out of direct marketing communications by writing to us at contact@euler.foundation. Do note that if you do not allow us to collect or process the required personal information or withdraw the consent to process the same for the required purposes, you may not be able to access or use the services for which your information was sought.
